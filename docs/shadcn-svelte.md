...
- [Radio Group](https://shadcn-svelte.com/docs/components/radio-group.md): A set of checkable buttonsвЂ”known as radio buttonsвЂ”where no more than one of the buttons can be checked at a time.
- [Select](https://shadcn-svelte.com/docs/components/select.md): Displays a list of options for the user to pick fromвЂ”triggered by a button.
...
- [Tabs](https://shadcn-svelte.com/docs/components/tabs.md): A set of layered sections of contentвЂ”known as tab panelsвЂ”that are displayed one at a time.
...
- [Context Menu](https://shadcn-svelte.com/docs/components/context-menu.md): Displays a menu to the user вЂ” such as a set of actions or functions вЂ” triggered by right click.
...
- [Dropdown Menu](https://shadcn-svelte.com/docs/components/dropdown-menu.md): Displays a menu to the user вЂ” such as a set of actions or functions вЂ” triggered by a button.
